...
function Star(props: StarPropType) {
  ...
  return (
      <span onClick={ props.onClickValueHandler }>
        { props.selected ? <b> Star </b> : ' Star' }
      </span>
  )
  // return props.selected ? <span onClick={ props.onClickValueHandler }><b> Star </b> </span> : <span onClick={ props.onClickValueHandler }> Star </span>
  // if (props.selected) {
